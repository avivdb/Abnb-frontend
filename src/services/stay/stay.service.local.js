...
async function save(stay) {
    ...
    if (stay._id) {
        ...
        const stayToSave = {
            ...
            beds: 1,
            baths: 2,
            defaultCheckin: '2024-08-12',
            defaultCheckout:'2024-08-19',
            // defaultCheckin: '2024/08/12',
            // defaultCheckout:'2024/08/19',
            // defaultCheckin: new Date('2024-08-12T12:30:00').getTime(),
            // defaultCheckout: new Date('2024-08-19T12:30:00').getTime(),
        }
        ...
        stays = [
            {
                ...
                "baths": 2,
                "isWishlist": false,
                "defaultCheckin": '2024-08-11',
                "defaultCheckout": '2024-08-15',
                // "defaultCheckin": '2024/08/11',
                // "defaultCheckout": '2024/08/15',
                // "defaultCheckin": new Date('2024-08-11T12:30:00').getTime(),
                // "defaultCheckout": new Date('2024-08-15T12:30:00').getTime(),
            },
            {
                "_id": "s102",
                ...
                "isWishlist": false,
                "defaultCheckin": '2024-08-12',
                "defaultCheckout": '2024-08-17',
                // "defaultCheckin": '2024/08/12',
                // "defaultCheckout": '2024/08/17',
                // "defaultCheckin": new Date('2024-08-12T12:30:00').getTime(),
                // "defaultCheckout": new Date('2024-08-17T12:30:00').getTime(),
            },
            {
                "_id": "s103",
                ...
                "baths": 5,
                "isWishlist": true,
                "defaultCheckin": '2024-08-10',
                "defaultCheckout": '2024-08-15',
                // "defaultCheckin": '2024/08/10',
                // "defaultCheckout": '2024/08/15',
                // "defaultCheckin": new Date('2024-08-10T12:30:00').getTime(),
                // "defaultCheckout": new Date('2024-08-15T12:30:00').getTime(),
            },
            {
                "_id": "s104",
                ...
                "baths": 4,
                "isWishlist": false,
                "defaultCheckin": '2024-09-15',
                "defaultCheckout": '2024-09-22',
                // "defaultCheckin": '2024/09/15',
                // "defaultCheckout": '2024/08/22',
                // "defaultCheckin": new Date('2024-09-15T12:30:00').getTime(),
                // "defaultCheckout": new Date('2024-08-22T12:30:00').getTime(),
            },
            {
                "_id": "s105",
                ...
                "baths": 2,
                "isWishlist": true,
                "defaultCheckin": '2024-08-25',
                "defaultCheckout": '2024-08-28',
                // "defaultCheckin": '2024/08/25',
                // "defaultCheckout": '2024/08/28',
                // "defaultCheckin": new Date('2024-08-25T12:30:00').getTime(),
                // "defaultCheckout": new Date('2024-08-28T12:30:00').getTime(),
            },
            {
                "_id": "s106",
                ...
                "isWishlist": false,
                "defaultCheckin": '2024-08-11',
                "defaultCheckout": '2024-08-18',
                // "defaultCheckin": '2024/08/11',
                // "defaultCheckout": '2024/08/18',
                // "defaultCheckin": new Date('2024-08-11T12:30:00').getTime(),
                // "defaultCheckout": new Date('2024-08-18T12:30:00').getTime(),
            }
        ]
    }
